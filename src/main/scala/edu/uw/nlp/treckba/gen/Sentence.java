...
public class Sentence implements org.apache.thrift.TBase<Sentence, Sentence._Fields>, java.io.Serializable, Cloneable, Comparable<Sentence> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Sentence struct) throws org.apache.thrift.TException {
      ...
      if (struct.tokens != null) {
        oprot.writeFieldBegin(TOKENS_FIELD_DESC);
        {
          ...
          for (Token _iter64 : struct.tokens)
          {
            _iter64.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.labels != null) {
        if (struct.isSetLabels()) {
          oprot.writeFieldBegin(LABELS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<Label>> _iter65 : struct.labels.entrySet())
            {
              oprot.writeString(_iter65.getKey());
              {
                ...
                for (Label _iter66 : _iter65.getValue())
                {
                  _iter66.write(oprot);
                }
                oprot.writeListEnd();
  ...
  private static class SentenceTupleScheme extends TupleScheme<Sentence> {
      ...
      if (struct.isSetTokens()) {
        {
          ...
          for (Token _iter67 : struct.tokens)
          {
            _iter67.write(oprot);
          }
        }
      ...
      if (struct.isSetLabels()) {
        {
          ...
          for (Map.Entry<String, List<Label>> _iter68 : struct.labels.entrySet())
          {
            oprot.writeString(_iter68.getKey());
            {
              oprot.writeI32(_iter68.getValue().size());
              for (Label _iter69 : _iter68.getValue())
              {
                _iter69.write(oprot);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Sentence struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tokens = new ArrayList<Token>(_list70.size);
          for (int _i71 = 0; _i71 < _list70.size; ++_i71)
          {
            Token _elem72;
            _elem72 = new Token();
            _elem72.read(iprot);
            struct.tokens.add(_elem72);
          }
        }
        struct.setTokensIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map73 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
          struct.labels = new HashMap<String,List<Label>>(2*_map73.size);
          for (int _i74 = 0; _i74 < _map73.size; ++_i74)
          {
            ...
            _key75 = iprot.readString();
            {
              ...
              _val76 = new ArrayList<Label>(_list77.size);
            ...
            struct.labels.put(_key75, _val76);
          }
        }
        struct.setLabelsIsSet(true);
      }
