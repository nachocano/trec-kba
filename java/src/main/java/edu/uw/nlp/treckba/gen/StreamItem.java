...
public class StreamItem implements org.apache.thrift.TBase<StreamItem, StreamItem._Fields>, java.io.Serializable, Cloneable, Comparable<StreamItem> {
  ...
  public StreamItem() {
    this.version = edu.uw.nlp.treckba.gen.Versions.v0_3_0;
...
;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.source_metadata = new HashMap<String,ByteBuffer>(2*_map216.size);
                for (int _i217 = 0; _i217 < _map216.size; ++_i217)
                {
                  ...
                  struct.source_metadata.put(_key218, _val219);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.other_content = new HashMap<String,ContentItem>(2*_map220.size);
                for (int _i221 = 0; _i221 < _map220.size; ++_i221)
                {
                  String _key222;
                  ContentItem _val223;
                  _key222 = iprot.readString();
                  _val223 = new ContentItem();
                  _val223.read(iprot);
                  struct.other_content.put(_key222, _val223);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ratings = new HashMap<String,List<Rating>>(2*_map224.size);
                for (int _i225 = 0; _i225 < _map224.size; ++_i225)
                {
                  ...
                  _key226 = iprot.readString();
                  {
                    ...
                    _val227 = new ArrayList<Rating>(_list228.size);
                  ...
                  struct.ratings.put(_key226, _val227);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.external_ids = new HashMap<String,Map<String,String>>(2*_map231.size);
                for (int _i232 = 0; _i232 < _map231.size; ++_i232)
                {
                  String _key233;
                  Map<String,String> _val234;
                  _key233 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map235 = iprot.readMapBegin();
                    _val234 = new HashMap<String,String>(2*_map235.size);
                  ...
                  struct.external_ids.put(_key233, _val234);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.source_metadata != null) {
        if (struct.isSetSource_metadata()) {
          oprot.writeFieldBegin(SOURCE_METADATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ByteBuffer> _iter239 : struct.source_metadata.entrySet())
            {
      ...
      if (struct.other_content != null) {
        if (struct.isSetOther_content()) {
          oprot.writeFieldBegin(OTHER_CONTENT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ContentItem> _iter240 : struct.other_content.entrySet())
            {
      ...
      if (struct.ratings != null) {
        if (struct.isSetRatings()) {
          oprot.writeFieldBegin(RATINGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<Rating>> _iter241 : struct.ratings.entrySet())
            {
              oprot.writeString(_iter241.getKey());
              {
                ...
                for (Rating _iter242 : _iter241.getValue())
                {
      ...
      if (struct.external_ids != null) {
        if (struct.isSetExternal_ids()) {
          oprot.writeFieldBegin(EXTERNAL_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,String>> _iter243 : struct.external_ids.entrySet())
            {
              oprot.writeString(_iter243.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, _iter243.getValue().size()));
                for (Map.Entry<String, String> _iter244 : _iter243.getValue().entrySet())
                {
  ...
  private static class StreamItemTupleScheme extends TupleScheme<StreamItem> {
      ...
      if (struct.isSetSource_metadata()) {
        {
          ...
          for (Map.Entry<String, ByteBuffer> _iter245 : struct.source_metadata.entrySet())
          {
            oprot.writeString(_iter245.getKey());
            oprot.writeBinary(_iter245.getValue());
          }
        }
      }
      if (struct.isSetStream_id()) {
      ...
      if (struct.isSetOther_content()) {
        {
          ...
          for (Map.Entry<String, ContentItem> _iter246 : struct.other_content.entrySet())
          {
      ...
      if (struct.isSetRatings()) {
        {
          ...
          for (Map.Entry<String, List<Rating>> _iter247 : struct.ratings.entrySet())
          {
            oprot.writeString(_iter247.getKey());
            {
              oprot.writeI32(_iter247.getValue().size());
              for (Rating _iter248 : _iter247.getValue())
              {
      ...
      if (struct.isSetExternal_ids()) {
        {
          ...
          for (Map.Entry<String, Map<String,String>> _iter249 : struct.external_ids.entrySet())
          {
            oprot.writeString(_iter249.getKey());
            {
              oprot.writeI32(_iter249.getValue().size());
              for (Map.Entry<String, String> _iter250 : _iter249.getValue().entrySet())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StreamItem struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map251 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.source_metadata = new HashMap<String,ByteBuffer>(2*_map251.size);
          for (int _i252 = 0; _i252 < _map251.size; ++_i252)
          {
            ...
            struct.source_metadata.put(_key253, _val254);
          }
        }
        struct.setSource_metadataIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TMap _map255 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.other_content = new HashMap<String,ContentItem>(2*_map255.size);
          for (int _i256 = 0; _i256 < _map255.size; ++_i256)
          {
            String _key257;
            ContentItem _val258;
            _key257 = iprot.readString();
            _val258 = new ContentItem();
            _val258.read(iprot);
            struct.other_content.put(_key257, _val258);
          }
        }
        struct.setOther_contentIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.ratings = new HashMap<String,List<Rating>>(2*_map259.size);
          for (int _i260 = 0; _i260 < _map259.size; ++_i260)
          {
            ...
            _key261 = iprot.readString();
            {
              ...
              _val262 = new ArrayList<Rating>(_list263.size);
            ...
            struct.ratings.put(_key261, _val262);
          }
        }
        struct.setRatingsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.external_ids = new HashMap<String,Map<String,String>>(2*_map266.size);
          for (int _i267 = 0; _i267 < _map266.size; ++_i267)
          {
            String _key268;
            Map<String,String> _val269;
            _key268 = iprot.readString();
            {
              ...
              _val269 = new HashMap<String,String>(2*_map270.size);
            ...
            struct.external_ids.put(_key268, _val269);
          }
        }
        struct.setExternal_idsIsSet(true);
      }
