...
public class Rating implements org.apache.thrift.TBase<Rating, Rating._Fields>, java.io.Serializable, Cloneable, Comparable<Rating> {
  ...
  private static final org.apache.thrift.protocol.TField FLAGS_FIELD_DESC = new org.apache.thrift.protocol.TField("flags", org.apache.thrift.protocol.TType.LIST, (short)7);
  ...
  private _Fields optionals[] = {_Fields.RELEVANCE,_Fields.CONTAINS_MENTION,_Fields.COMMENTS,_Fields.MENTIONS,_Fields.FLAGS};
   ...
   * as meeting an extensible set of criteria.
   */
  public Rating setFlags(List<FlagType> flags) {
    this.flags = flags;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mentions = new ArrayList<String>(_list200.size);
                for (int _i201 = 0; _i201 < _list200.size; ++_i201)
                {
                  String _elem202;
                  _elem202 = iprot.readString();
                  struct.mentions.add(_elem202);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.flags = new ArrayList<FlagType>(_list203.size);
                for (int _i204 = 0; _i204 < _list203.size; ++_i204)
                {
                  FlagType _elem205;
                  _elem205 = FlagType.findByValue(iprot.readI32());
                  struct.flags.add(_elem205);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.mentions != null) {
        if (struct.isSetMentions()) {
          oprot.writeFieldBegin(MENTIONS_FIELD_DESC);
          {
            ...
            for (String _iter206 : struct.mentions)
            {
      ...
      if (struct.flags != null) {
        if (struct.isSetFlags()) {
          oprot.writeFieldBegin(FLAGS_FIELD_DESC);
          {
            ...
            for (FlagType _iter207 : struct.flags)
            {
      ...
      if (struct.isSetMentions()) {
        {
          ...
          for (String _iter208 : struct.mentions)
          {
      ...
      if (struct.isSetFlags()) {
        {
          ...
          for (FlagType _iter209 : struct.flags)
          {
            oprot.writeI32(_iter209.getValue());
          }
        }
      }
    }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.mentions = new ArrayList<String>(_list210.size);
          for (int _i211 = 0; _i211 < _list210.size; ++_i211)
          {
            String _elem212;
            _elem212 = iprot.readString();
            struct.mentions.add(_elem212);
          }
        }
        struct.setMentionsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.flags = new ArrayList<FlagType>(_list213.size);
          for (int _i214 = 0; _i214 < _list213.size; ++_i214)
          {
            FlagType _elem215;
            _elem215 = FlagType.findByValue(iprot.readI32());
            struct.flags.add(_elem215);
          }
        }
        struct.setFlagsIsSet(true);
      }
