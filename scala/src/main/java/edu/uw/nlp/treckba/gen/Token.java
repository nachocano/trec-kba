...
public class Token implements org.apache.thrift.TBase<Token, Token._Fields>, java.io.Serializable, Cloneable, Comparable<Token> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.offsets = new HashMap<OffsetType,Offset>(2*_map26.size);
                for (int _i27 = 0; _i27 < _map26.size; ++_i27)
                {
                  OffsetType _key28;
                  Offset _val29;
                  _key28 = OffsetType.findByValue(iprot.readI32());
                  _val29 = new Offset();
                  _val29.read(iprot);
                  struct.offsets.put(_key28, _val29);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.labels = new HashMap<String,List<Label>>(2*_map30.size);
                for (int _i31 = 0; _i31 < _map30.size; ++_i31)
                {
                  ...
                  _key32 = iprot.readString();
                  {
                    ...
                    _val33 = new ArrayList<Label>(_list34.size);
                  ...
                  struct.labels.put(_key32, _val33);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.offsets != null) {
        if (struct.isSetOffsets()) {
          oprot.writeFieldBegin(OFFSETS_FIELD_DESC);
          {
            ...
            for (Map.Entry<OffsetType, Offset> _iter37 : struct.offsets.entrySet())
            {
      ...
      if (struct.labels != null) {
        if (struct.isSetLabels()) {
          oprot.writeFieldBegin(LABELS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<Label>> _iter38 : struct.labels.entrySet())
            {
              oprot.writeString(_iter38.getKey());
              {
                ...
                for (Label _iter39 : _iter38.getValue())
                {
                  _iter39.write(oprot);
                }
                oprot.writeListEnd();
  ...
  private static class TokenTupleScheme extends TupleScheme<Token> {
      ...
      if (struct.isSetOffsets()) {
        {
          ...
          for (Map.Entry<OffsetType, Offset> _iter40 : struct.offsets.entrySet())
          {
      ...
      if (struct.isSetLabels()) {
        {
          ...
          for (Map.Entry<String, List<Label>> _iter41 : struct.labels.entrySet())
          {
            oprot.writeString(_iter41.getKey());
            {
              oprot.writeI32(_iter41.getValue().size());
              for (Label _iter42 : _iter41.getValue())
              {
                _iter42.write(oprot);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Token struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map43 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.offsets = new HashMap<OffsetType,Offset>(2*_map43.size);
          for (int _i44 = 0; _i44 < _map43.size; ++_i44)
          {
            OffsetType _key45;
            Offset _val46;
            _key45 = OffsetType.findByValue(iprot.readI32());
            _val46 = new Offset();
            _val46.read(iprot);
            struct.offsets.put(_key45, _val46);
          }
        }
        struct.setOffsetsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.labels = new HashMap<String,List<Label>>(2*_map47.size);
          for (int _i48 = 0; _i48 < _map47.size; ++_i48)
          {
            ...
            _key49 = iprot.readString();
            {
              ...
              _val50 = new ArrayList<Label>(_list51.size);
            ...
            struct.labels.put(_key49, _val50);
          }
        }
        struct.setLabelsIsSet(true);
      }
