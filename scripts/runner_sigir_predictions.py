...
def main():
  ...
  for alpha, alpha_name in alphas:
    clu_dyn = 'nohup ~/py_virtual/bin/python -u repo/trec-kba/scripts/clustering_uv.py -e trec-kba-2014-07-11-ccr-and-ssf-query-topics.json \
              ...
              > logs/uw-lsi_clu_dyn_a%s_gd%s_gi%s.log' % (alpha_name, gamma_decrease[1], gamma_increase[1], alpha_name, gamma_decrease[1], gamma_increase[1], alpha_name, gamma_decrease[1], gamma_increase[1], alpha_name, gamma_decrease[1], gamma_increase[1], alpha_name, gamma_decrease[1], gamma_increase[1])
    print clu_dyn
    os.system(clu_dyn)
  ...
  for alpha, alpha_name in alphas:
    clu_stat = 'nohup ~/py_virtual/bin/python -u repo/trec-kba/scripts/clustering_uv.py -e trec-kba-2014-07-11-ccr-and-ssf-query-topics.json \
              ...
              -nr nr.txt \
              -o outputs/uw-lsi_clu_stat_a%s_gd0_gi1 \
              > logs/uw-lsi_clu_stat_a%s_gd0_gi1.log' % (alpha_name, alpha_name, alpha_name, alpha_name, alpha_name)
    print clu_stat
    os.system(clu_stat)
